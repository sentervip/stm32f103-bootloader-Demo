 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
 ...
 #ifdef STM32F10X_CL   
  #define HSE_VALUE    ((uint32_t)12000000) /* 8000000!< Value of the External oscillator in Hz */
 #else 
//cck  #define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */
